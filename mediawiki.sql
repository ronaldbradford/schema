...
--
-- Current Database: `mediawiki`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `mediawiki` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
) ENGINE=MyISAM AUTO_INCREMENT=21 DEFAULT CHARSET=binary;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=21 DEFAULT CHARSET=binary MAX_ROWS=10000000 AVG_ROW_LENGTH=1024;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `text` (
  ...
  PRIMARY KEY (`old_id`)
) ENGINE=MyISAM AUTO_INCREMENT=21 DEFAULT CHARSET=binary MAX_ROWS=10000000 AVG_ROW_LENGTH=10240;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2012-11-22 12:40:04
